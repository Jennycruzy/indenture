...
| `Corridor` (v2, active)  | [`0xD77489caCa9C6549CCeD4A500B46019BE2d225c4`](https://sepolia.etherscan.io/address/0xD77489caCa9C6549CCeD4A500B46019BE2d225c4) | [`0x932676a15fd4c1392dd8cc66e35eb0c4fea00e9ec7d9d735b52a8ae4ffee62a8`](https://sepolia.etherscan.io/tx/0x932676a15fd4c1392dd8cc66e35eb0c4fea00e9ec7d9d735b52a8ae4ffee62a8) | 11,217,667 | 1,109,858 |
| `Corridor` (v1, retired) | [`0x4A3c965edb96f74451fe5921686e44CbFF4a8A7b`](https://sepolia.etherscan.io/address/0x4A3c965edb96f74451fe5921686e44CbFF4a8A7b) | [`0x351b8a0c7721cf462ec9f2d13ef2b2c676113386592fe447e8022532027fe359`](https://sepolia.etherscan.io/tx/0x351b8a0c7721cf462ec9f2d13ef2b2c676113386592fe447e8022532027fe359) | 11,210,851 |   853,737 |

`Corridor` v1 is **retired**: its sealed lifetime `totalCap` (1000) is fully spent, and `totalCap` is immutable, so it can never clear another transfer. v2 (mandate `cloistra-sepolia-corridor-v2`, `totalCap` 100000) supersedes it and is the address wired into the frontend + off-ramp listener.
...
Fresh corridor v2 (2026-07-06) — v1 exhausted its immutable `totalCap`, so a new Corridor `0xD77489caCa9C6549CCeD4A500B46019BE2d225c4` (`totalCap` 100000, custody 10000) was deployed and provisioned; loop closed again on the first cleared transfer:

| Step                          | Detail                                                                                                                                                                                                                                     |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Sender transfer (100), clears | [`0xbdbc826726c86c2ad8c4fdbe8fa7247fd592977954fb270c080e59ac6191a19c`](https://sepolia.etherscan.io/tx/0xbdbc826726c86c2ad8c4fdbe8fa7247fd592977954fb270c080e59ac6191a19c) (block `11,217,695`, nonce `1`)                                 |
| Officer decrypt               | sealed `moved` decrypted to `100`                                                                                                                                                                                                          |
| Flutterwave sandbox payout    | `provider=flutterwave-v3` `reference=cloistra-0xD77489caCa9C6549CCeD4A500B46019BE2d225c4-1_PMCKDU_1` `id=2192988` `amount=100 NGN` `status=SUCCESSFUL`                                                                                     |
| Over-cap (150), nullified     | [`0xec0c3753c7af16fba37513b5467ed7f3e1d885fe94ffbd389b2a61bc5ec4f9d9`](https://sepolia.etherscan.io/tx/0xec0c3753c7af16fba37513b5467ed7f3e1d885fe94ffbd389b2a61bc5ec4f9d9) (block `11,217,700`, nonce `2`) → sealed `moved = 0`, no payout |
